...
public class PantallaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        img2.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jPanel1.add(img2);
        img2.setBounds(550, 10, 240, 320);
        ...
        public void run() {
            try {                                             
                ...
                if (!r[0].isEmpty()){
                    ...
                    tNumSer.setText(r[0]);
                    System.out.println("Duró: "+(float)(System.nanoTime() - startTime)/1000000000+" segundos");
                    System.out.println("Terminó de cargar datos, ahora a cargar Foto");
                    
                    /////////  Cartel de cargando //////////////
                    BufferedImage img = null;
                    img = ImageIO.read(new File("src/loading.jpg"));
                    img2.setIcon(new ImageIcon( img ));
                    System.out.println("Duró: "+(float)(System.nanoTime() - startTime)/1000000000+" segundos");
                    //////// Leer y cargar foto de la cédula ////////////
                    r = sc.leerCedula(1);
                    ...
                    img2.setIcon(new ImageIcon( img ));
                    System.out.println("Duró en total: "+(float)(System.nanoTime() - startTime)/1000000000+" segundos");
